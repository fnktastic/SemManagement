...
{
    public class SongsExtendedCollection : ObservableCollection<SongExtended>
    {
        public SongsExtendedCollection(IList<SongExtended> songs) : base(songs)
        {
