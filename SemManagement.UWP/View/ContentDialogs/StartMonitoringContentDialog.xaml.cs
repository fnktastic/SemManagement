...
{
    public sealed partial class StartMonitoringContentDialog : ContentDialog
    {
        public StartMonitoringViewModel SendToStationViewModel { get; private set; }

        public StartMonitoringContentDialog(StartMonitoringViewModel vm)
        {
